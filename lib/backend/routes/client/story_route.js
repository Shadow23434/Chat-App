...
import { getStory, getOwnStory, createStory, likeStory, unlikeStory, deleteStory } from '../../controllers/client/story_controller.js';
...
// Route để lấy story của user hiện tại
router.get('/own', getOwnStory);
